        ...
        <div class="container">
            ...
            <div class="breadcrumbss">
                ...
                <ul class="page_parents pull-right">
                    ...
                    <li class="breadcrumbs_c"><a class="breadcrumbs_c" href="{{route('men-products')}}">Women Products</a>
                    </li>
...
@section('content')
    ...
    <section id="content" class="content_portfolio layout-fullsize items-layout-boxed" style="background:;">
        <br/><br/><br/>
        <h1 class="portfolio_big_title">Women Products</h1>
            ...
            <div class="row-fluid">
                <section id="portfolio-preview-items" class="three-cols span12" data-nr="3">
                    ...
                    <div class="row filterable isotope" style="position: relative; overflow: hidden; height: 1077px;">
                        ...
                        <!-- item -->
                        @foreach($response['womenproducts'] as $row)
                                    ...
                                    <div class="overlay he-view">
                                        <div class="bg a0 fadeIn" data-animate="fadeIn">
                                            <div class="center-bar v1">
                                                ...
                                                <a href="#" class="categories a4 fadeInUp" data-animate="fadeInUp">{{$row->price}} Ks  </a>
                                            </div>
                                        </div>
