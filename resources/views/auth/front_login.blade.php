                                            ...
                                            <div class="row-fluid">
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        ...
                                                        <form name="loginForm" class="standard-form row-fluid"  action="{{ url('/login') }}" method="POST">
                                                            {!! csrf_field() !!}
                                                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                                                    <input type="email" class="themeple_pw" name="email" value="{{ old('email') }}" required placeholder="Username or Email" style="padding: 15px;border-radius: 0px;">
                                                                @if ($errors->has('email'))
                                                            ...
                                                            <div class="span6" style="margin-left: 0px;">
                                                                <input type="submit" value="LOGIN" class="btn-system normal default style_login">
                                                            </div>
                                                        </form>
